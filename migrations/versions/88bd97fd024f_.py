...
def upgrade():
    ...
    sa.Column('country', sa.Enum('Jordan', 'Faroe Islands', 'Congo', 'Haiti', 'Colombia', 'Switzerland', 'Timor-Leste', 'Sao Tome and Principe', 'Mexico', 'Georgia', 'Cape Verde', 'Iraq', 'Tunisia', 'Benin', 'Myanmar', 'Malawi', 'Greenland', 'Nepal', 'Cuba', 'Japan', 'Turkey', 'Ireland', 'United Arab Emirates', 'El Salvador', 'Uruguay', 'Brunei Darussalam', 'Sudan', 'Uganda', 'American Samoa', 'Papua New Guinea', 'United States Minor Outlying Islands', 'Ecuador', 'Nicaragua', "Korea, Democratic People's Republic of", 'Virgin Islands, British', 'Zambia', 'Singapore', 'Liechtenstein', 'Finland', 'Chile', 'Turks and Caicos Islands', 'Heard Island and Mcdonald Islands', 'Iceland', 'Libyan Arab Jamahiriya', 'Madagascar', 'Congo, the Democratic Republic of the', 'Cambodia', 'Guinea-Bissau', 'United States', 'Barbados', 'Estonia', 'Albania', 'Lithuania', 'Azerbaijan', 'Seychelles', 'Afghanistan', 'Jamaica', 'Niger', 'Peru', 'Ethiopia', 'Saint Kitts and Nevis', 'Mauritius', 'Canada', 'Puerto Rico', 'Bahamas', 'Angola', 'Senegal', 'Aruba', 'Serbia and Montenegro', 'Burundi', 'Western Sahara', 'Norfolk Island', 'Pakistan', 'Korea, Republic of', 'Macao', 'Portugal', 'Wallis and Futuna', 'Ukraine', 'Bermuda', 'Macedonia, the Former Yugoslav Republic of', 'Guadeloupe', 'Thailand', 'Guatemala', 'Slovenia', 'Moldova, Republic of', 'Oman', 'Nauru', 'Bosnia and Herzegovina', 'Saint Helena', 'Tonga', 'Togo', 'Brazil', 'Botswana', 'Qatar', 'South Africa', 'Romania', 'Lebanon', 'Liberia', 'Cook Islands', 'Hong Kong', 'Mozambique', 'Uzbekistan', 'New Zealand', 'Sweden', 'Fiji', 'Malta', 'Argentina', 'Namibia', 'Kazakhstan', 'Hungary', 'Suriname', 'French Guiana', 'Guam', 'Netherlands', 'Monaco', 'Dominican Republic', 'New Caledonia', 'South Georgia and the South Sandwich Islands', 'Denmark', 'Turkmenistan', 'United Kingdom', 'Christmas Island', 'Bulgaria', 'Montserrat', 'Belgium', 'Anguilla', 'Virgin Islands, U.s.', 'French Polynesia', 'Israel', 'Kyrgyzstan', 'Greece', 'Rwanda', 'Cocos (Keeling) Islands', "Lao People's Democratic Republic", 'Central African Republic', 'Antarctica', 'Venezuela', 'Tuvalu', 'Poland', 'Ghana', 'Marshall Islands', 'Panama', 'Samoa', 'China', 'British Indian Ocean Territory', 'Palau', 'Yemen', 'Guyana', 'Saudi Arabia', 'Viet Nam', 'Sierra Leone', 'Guinea', 'San Marino', 'Bouvet Island', 'Gambia', 'Tajikistan', 'Tanzania, United Republic of', "Cote D'Ivoire", 'Syrian Arab Republic', 'Swaziland', 'Mauritania', 'Paraguay', 'Martinique', 'Somalia', 'Luxembourg', 'Palestinian Territory, Occupied', 'Mayotte', 'Iran, Islamic Republic of', 'Malaysia', 'Nigeria', 'Italy', 'Morocco', 'Austria', 'Slovakia', 'Burkina Faso', 'Pitcairn', 'Falkland Islands (Malvinas)', 'Vanuatu', 'Eritrea', 'Cyprus', 'Costa Rica', 'Dominica', 'Gabon', 'Bolivia', 'Bangladesh', 'Cameroon', 'Northern Mariana Islands', 'Sri Lanka', 'Andorra', 'Chad', 'Egypt', 'Maldives', 'Saint Vincent and the Grenadines', 'Australia', 'Cayman Islands', 'Indonesia', 'Croatia', 'Holy See (Vatican City State)', 'Trinidad and Tobago', 'Latvia', 'Djibouti', 'Spain', 'Kenya', 'Taiwan, Province of China', 'Lesotho', 'Saint Lucia', 'Norway', 'Grenada', 'Belize', 'Kiribati', 'Tokelau', 'Antigua and Barbuda', 'Zimbabwe', 'Reunion', 'French Southern Territories', 'Germany', 'Kuwait', 'Bhutan', 'Gibraltar', 'Equatorial Guinea', 'Comoros', 'Bahrain', 'Svalbard and Jan Mayen', 'Czech Republic', 'Philippines', 'Micronesia, Federated States of', 'France', 'Netherlands Antilles', 'Solomon Islands', 'Niue', 'Algeria', 'Saint Pierre and Miquelon', 'Mongolia', 'India', 'Belarus', 'Armenia', 'Honduras', 'Russian Federation', 'Mali', name='countries'), nullable=True),
    sa.Column('contact_id', sa.String(length=5), nullable=True),
    sa.Column('company_id', sa.String(length=5), nullable=True),
